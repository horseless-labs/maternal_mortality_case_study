...
## Introduction
The impetus for this case study was an article from the Guardian reporting that [US maternal deaths rose in 2020, with Black mothers at far higher risk](https://www.theguardian.com/us-news/2022/feb/23/us-maternal-deaths-mortality-black-mothers-covid). This inspired me to do a more detailed examination of the data. Having looked at statistics comparing US and western European populations before, I have noticed that the broad statistics sometimes look different for the US as a whole than when it is divided into subpopulations. For instance, the birth rate among White middle-class Americans more closely tracks their European counterparts than would be expected. Thus, it is possible that recommendations for changes to fix any given problem might be specific to these subpopulations.

## Initial Questions to Investigate
Keeping the above in mind, these were some of the starting points that this case study was meant to investigate:

- Does the White middle-class population have a maternal mortality rate much different from their western European counterparts?
- In examining socioeconomic indicators, will e.g. Whites and Blacks of similar such status have similar maternal mortality rates?
- Could other demographic changes be responsible for the increase in maternal mortality in general?
...
```{r}
# Move this to helper_functions.R
...
Bearing that in mind, how do these rates compare with the other nations listed above?

...
o99_secondary_pre_counts <- strip_codes_to_char(o99_secondary_pre)
o99_secondary_pre_counts <- as_tibble(o99_secondary_pre_counts)
o99_secondary_pre_counts <- o99_secondary_pre_counts %>%
  select(codes = 1) %>%
  group_by(codes) %>%
  summarise(counts = n()) %>%
  arrange(desc(counts))
